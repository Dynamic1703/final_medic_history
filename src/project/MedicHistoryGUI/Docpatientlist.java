...
public class Docpatientlist extends javax.swing.JFrame {
    ...
    ResultSet rs;
     rs = stmt.executeQuery("select ca.doctorID, COUNT(ca.patientID) as num_patients FROM appointment ca join appointment_details a ON ca.appointmentID = a.appointmentID where ca.doctorID = '" + doctorID + "' AND a.is_confirmed = '1'");
